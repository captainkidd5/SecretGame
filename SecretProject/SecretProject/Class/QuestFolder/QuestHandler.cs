...
namespace SecretProject.Class.QuestFolder
{
    public class QuestHandler
    {
        ...
        public void PerformReward()
        {
            ...
            Game1.Player.UserInterface.AddAlert(UI.AlertType.Normal, Game1.Utility.CenterRectangleOnScreen(new Rectangle(0,0,64,64),2f), ActiveQuest.UnlockDescription);
