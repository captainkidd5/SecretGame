    ...
    public class StaminaBar
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (Game1.GetCurrentStageInt() == (int)Stages.World)
            {
                ...
                spriteBatch.Draw(ColoredRectangle, ColoredRectanglePosition, null, Color.White, 0f, Game1.Utility.Origin, 1f, SpriteEffects.None, Game1.Utility.StandardButtonDepth);
                spriteBatch.DrawString(Game1.AllTextures.MenuText, Stamina.ToString(), this.PositionToDraw, Color.Black, 0f, Game1.Utility.Origin, 3f, SpriteEffects.None, Game1.Utility.StandardButtonDepth);
            }
        }
    }
}
