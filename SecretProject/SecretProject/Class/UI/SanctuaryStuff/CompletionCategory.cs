...
namespace SecretProject.Class.UI.SanctuaryStuff
{
    public class CompletionCategory
    {
        ...
        public List<CompletionPage> Pages { get; set; }
        ...
        public CompletionCategory(string name, GraphicsDevice graphics, Vector2 positionToDraw, Rectangle sourceRectangle, float scale)
        {
            this.Name = name;
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 backGroundPosition)
        {
            ...
            this.Pages[this.ActivePage].Draw(spriteBatch, backGroundPosition);
        }
    }
}
