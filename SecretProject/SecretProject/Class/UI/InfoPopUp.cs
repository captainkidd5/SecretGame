    ...
    public class InfoPopUp
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if(this.IsActive)
            {
                ...
                spriteBatch.DrawString(Game1.AllTextures.MenuText, this.StringToWrite, this.WindowPosition, Color.Black, 0f, Game1.Utility.Origin, 2f, SpriteEffects.None, .81f);
            }
