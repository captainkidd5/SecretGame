...
namespace SecretProject.Class.UI.MainMenuStuff
{
    public class TypingWindow
    {
        ...
        {
            this.Button.Draw(spriteBatch, Game1.AllTextures.MenuText, this.EnteredString, Button.FontLocation, Button.Color,Utility.StandardButtonDepth, Utility.StandardTextDepth, 3f);
            if(this.IsIconDrawn)
            {
