...
namespace SecretProject.Class.NPCStuff
{
    public class Elixir : Character
    {
        ...
        public Elixir(string name, Vector2 position, GraphicsDevice graphics, Texture2D spriteSheet,RouteSchedule routeSchedule):base(name, position, graphics, spriteSheet, routeSchedule, 0, false)
        {
            this.SpeakerID = 1;
