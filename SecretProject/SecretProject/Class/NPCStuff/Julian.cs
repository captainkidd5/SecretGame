...
namespace SecretProject.Class.NPCStuff
{
    ...
    {
        public Julian(string name, Vector2 position, GraphicsDevice graphics, Texture2D spriteSheet, RouteSchedule routeSchedule, QuestHandler questHandler, Texture2D characterPortraitTexture) : base(name, position, graphics, spriteSheet, routeSchedule, Stages.JulianHouse, false, questHandler, characterPortraitTexture)
        {
            this.SpeakerID = 5;
