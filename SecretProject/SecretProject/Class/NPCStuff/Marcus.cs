...
namespace SecretProject.Class.NPCStuff
{
    public class Marcus : Character
    {
        ...
        public Marcus(string name, Vector2 position, GraphicsDevice graphics, Texture2D spriteSheet, RouteSchedule routeSchedule, QuestHandler questHandler, Texture2D characterPortraitTexture) : base(name, position, graphics, spriteSheet, routeSchedule, Stages.MarcusHouse, false, questHandler, characterPortraitTexture)
        {
