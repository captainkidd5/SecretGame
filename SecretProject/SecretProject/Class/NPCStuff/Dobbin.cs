...
namespace SecretProject.Class.NPCStuff
{
    public class Dobbin  : Character
    {
        ...
        public Dobbin(string name, Vector2 position, GraphicsDevice graphics, Texture2D spriteSheet, RouteSchedule routeSchedule) : base(name, position, graphics, spriteSheet, routeSchedule, 7, false)
        {
