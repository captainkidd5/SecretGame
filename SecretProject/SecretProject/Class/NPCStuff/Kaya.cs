...
namespace SecretProject.Class.NPCStuff
{
    ...
    {
        public Kaya(string name, Vector2 position, GraphicsDevice graphics, Texture2D spriteSheet, RouteSchedule routeSchedule) : base(name, position, graphics, spriteSheet, routeSchedule, 1, false)
        {
            this.SpeakerID = 4;
