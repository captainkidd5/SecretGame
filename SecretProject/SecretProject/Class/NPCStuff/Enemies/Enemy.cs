    ...
    public class Enemy : INPC, IEntity, ICollidable
    {
        ...
        public virtual void Update(GameTime gameTime)
        {
            ...
            if (this.IsMoving)
            {
                ...
                CollisionBody.LinearVelocity = this.primaryVelocity * DirectionVector * 4 *(float)gameTime.ElapsedGameTime.TotalMilliseconds;
        ...
        {
           //REDO spriteBatch.Draw(this.HitBoxTexture, new Vector2(this.NPCHitBoxRectangle.X, this.NPCHitBoxRectangle.Y), color: Color.Green, layerDepth: 1f);
