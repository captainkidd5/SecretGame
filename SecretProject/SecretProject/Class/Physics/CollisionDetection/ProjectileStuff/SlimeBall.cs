...
namespace SecretProject.Class.CollisionDetection.ProjectileStuff
{
    ...
    {
        public SlimeBall(GraphicsDevice graphics, RectangleCollider colliderFiredFrom, Dir directionFiredFrom, Vector2 startPosition, float rotation, float speed, Vector2 positionToMoveToward, List<Projectile> allProjectiles, bool damagesPlayer, int damage) : base(graphics, colliderFiredFrom, directionFiredFrom, startPosition, rotation, speed, positionToMoveToward, allProjectiles, damagesPlayer, damage)
        {
