...
namespace SecretProject.Class.Universal
{
    public static class GameSerializer
    {
        ...
        public static void WriteStage(IProceduralWorld home, BinaryWriter writer, float version)
        {
        ...
        public static void ReadStage(IProceduralWorld home, GraphicsDevice graphics, BinaryReader reader, float version)
        {
