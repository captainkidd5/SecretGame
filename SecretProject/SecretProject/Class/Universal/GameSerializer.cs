...
namespace SecretProject.Class.Universal
{
    public static class GameSerializer
    {
        ...
        public static void WriteStage(ILocation home, BinaryWriter writer, float version)
        {
        ...
        public static void ReadStage(ILocation home, GraphicsDevice graphics, BinaryReader reader, float version)
        {
