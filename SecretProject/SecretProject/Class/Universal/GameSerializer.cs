...
namespace SecretProject.Class.Universal
{
    public static class GameSerializer
    {
        ...
        public static void WriteStage(ITmxStage home, BinaryWriter writer, float version)
        {
        ...
        public static void ReadStage(ITmxStage home, GraphicsDevice graphics, BinaryReader reader, float version)
        {
