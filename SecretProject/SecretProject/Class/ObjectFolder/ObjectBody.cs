...
namespace SecretProject.Class.ObjectFolder
{
    public class ObjectBody
    {
        ...
        {
            return this.Rectangle.Right + this.Velocity.X > sprite.DestinationRectangle.Left &&
                this.Rectangle.Left < sprite.DestinationRectangle.Left &&
                this.Rectangle.Bottom > sprite.DestinationRectangle.Top &&
                this.Rectangle.Top < sprite.DestinationRectangle.Bottom;
        }
        protected bool IsTouchingRight(Sprite sprite)
        {
            return this.Rectangle.Left + this.Velocity.X < sprite.DestinationRectangle.Right &&
                this.Rectangle.Right > sprite.DestinationRectangle.Right &&
                this.Rectangle.Bottom > sprite.DestinationRectangle.Top &&
                this.Rectangle.Top < sprite.DestinationRectangle.Bottom;
        }
        protected bool IsTouchingTop(Sprite sprite)
        {
            return this.Rectangle.Bottom + this.Velocity.Y > sprite.DestinationRectangle.Top &&
                this.Rectangle.Top < sprite.DestinationRectangle.Top &&
                this.Rectangle.Right > sprite.DestinationRectangle.Left &&
                this.Rectangle.Left < sprite.DestinationRectangle.Right;
        }
        protected bool IsTouchingBottom(Sprite sprite)
        {
            return this.Rectangle.Top + this.Velocity.Y < sprite.DestinationRectangle.Bottom &&
                this.Rectangle.Bottom > sprite.DestinationRectangle.Bottom &&
                this.Rectangle.Right > sprite.DestinationRectangle.Left &&
                this.Rectangle.Left < sprite.DestinationRectangle.Right;
        }
