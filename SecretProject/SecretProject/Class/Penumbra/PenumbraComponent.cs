...
namespace Penumbra
{
    ...
    public class PenumbraComponent : DrawableGameComponent
    {
        ...
        public PenumbraComponent(Game game, ContentManager content)
            : base(game)
        {
        ...
        public override void Initialize()
        {
            ...
            //    new ResourceManager("Resource.DesktopGL", typeof(PenumbraComponent).Assembly)
            ...
            _engine.Load(GraphicsDevice, deviceManager, Game.Window,
                _content.Load<Effect>("penumbra/PenumbraHull"),
            _content.Load<Effect>("penumbra/PenumbraLight"),
            _content.Load<Effect>("penumbra/PenumbraShadow"),
            _content.Load<Effect>("penumbra/PenumbraTexture"));
            _initialized = true;
        }
