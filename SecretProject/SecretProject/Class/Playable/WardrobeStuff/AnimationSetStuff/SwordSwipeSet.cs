...
namespace SecretProject.Class.Playable.WardrobeStuff.AnimationSetStuff
{
    public class SwordSwipeSet : AnimationSet
    {
        ...
        public SwordSwipeSet(string name, GraphicsDevice graphics, List<ClothingPiece> clothingPieces, int totalFrames, float speed) : base(name, graphics, clothingPieces, totalFrames, speed)
        {
        ...
        {
            throw new Exception("Sword set tried to update normally!");
        }
