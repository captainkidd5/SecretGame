...
namespace SecretProject.Class.Playable
{
    ...
    public class WardrobeNew : ISaveable
    {
        ...
        public ClothingSet[,] BasicMovementAnimations { get; set; }

        public ClothingSet[,] MiningAnimations { get; set; }
        public ClothingSet[,] SwipingAnimations { get; set; }
        public ClothingSet[,] GrabItemAnimations { get; set; }
        ...
        public WardrobeNew(GraphicsDevice graphics, Vector2 playerPosition)
        {
            ...
            this.BasicMovementAnimations = new ClothingSet[4, 5];
